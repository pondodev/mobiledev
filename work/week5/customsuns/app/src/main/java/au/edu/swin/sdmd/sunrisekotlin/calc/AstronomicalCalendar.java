 ...
 * condition a null will be returned when a <code>{@link Date}</code>
...
public class AstronomicalCalendar {
     ...
     * @return the {@link Date}with the offset added to it
     */
     ...
     * @param time   the start time
     * @param offset the offset in milliseconds to add to the time.
     * @return the {@link Date} with the offset in milliseconds added
     * to it
     */
     ...
     *
     * @param offsetZenith the degrees before {@link #getSunrise()} to use in the
     *                     calculation. For time after sunrise use negative numbers.
     * @return The {@link Date} of the offset after (or before)
     ...
     *
     * @param offsetZenith the degrees after {@link #getSunset()} to use in the
     ...
     *
     * @param geoLocation The location information used for astronomical calculating sun
     *                    times.
     */
     ...
     *
     * @param zenith the degrees below the horizon. For time after sunrise use
     *               negative numbers.
     ...
     * zone offset from GMT and without using daylight savings time.
     *
     * @param zenith the degrees below the horizon. For time after before sunset
     ...
     *
     * @param zenith the degrees below the horizon. For time before sunset use
     *               negative numbers.
     * @return The time in the format: 18.75 for 18:45:00 UTC/GMT. If the
     * calculation can't be computed such as in the Arctic Circle where
     * there is at least one day a year where the sun does not rise, and
     ...
     *
     * @param time The time to be set as the time for the <code>Date</code>. The
